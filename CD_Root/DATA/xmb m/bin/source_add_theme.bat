...
if exist "%pkgbasexmbmp%\APPTITLID\USRDIR\IMAGES\%themeid%\" (
...
mkdir "%pkgbasexmbmp%\APPTITLID\USRDIR\IMAGES\%themeid%" >NUL
xcopy /E "%pkgbasexmbmp%\APPTITLID\USRDIR\IMAGES\ORIGINAL" "%pkgbasexmbmp%\APPTITLID\USRDIR\IMAGES\%themeid%\" >NUL
...
%external%\ssr\ssr --nobackup --recurse --encoding utf8 --dir "%pkgbasexmbmp%\APPTITLID\USRDIR" --include "game_settings.xml" --alter --search "<Table key=''original''>" --replace "<Table key=''%themeid%''>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB//SSR_TAB/<Pair key=''icon''><String>/dev_hdd0/game/APPTITLID/USRDIR/IMAGES/settings.png</String></Pair><Pair key=''title''><String>LANG_TITL_SETTINGS-THEMES-PACKS-%themeid%</String></Pair>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB//SSR_TAB/<Pair key=''info''><String>LANG_INFO_SETTINGS-THEMES-PACKS-%themeid%</String></Pair>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB//SSR_TAB/<Pair key=''module_name''><String>webbrowser_plugin</String></Pair>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB//SSR_TAB/<Pair key=''module_action''><String>http://dl.dropbox.com/u/60710927/XMBMPLUS/RELEASES/THEMEPACKS/XMBM%2BvURL-XMBMP-VERSION-THEMEPACK-%themeid%.pkg</String></Pair>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/</Table>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/<Table key=''original''>"
%external%\ssr\ssr --nobackup --recurse --encoding utf8 --dir "%pkgbasexmbmp%\APPTITLID\USRDIR" --include "game_settings.xml" --alter --search "attr=''blue''/>" --replace "attr=''blue''/>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/<Item class=''type:x-xmb/module-action'' key=''%themeid%'' attr=''%themeid%''/>"

:done
call "%bindir%\global_messages.bat" "SOURCE-THEME-CREATED"
start explorer.exe "%pkgbasexmbmp%\APPTITLID\USRDIR\IMAGES\%themeid%\"
start %external%\notepad\notepad++.exe "%pkgbasexmbmp%\APPTITLID\USRDIR\IMAGES\%themeid%\themeinfo.xml"
goto :end
