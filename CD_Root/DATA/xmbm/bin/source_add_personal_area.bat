...
IF EXIST "%pkgbasesources%\APPTITLID\USRDIR\FEATURES\Personal_Area.offline" goto :create_personal_area
IF EXIST "%pkgbasesources%\APPTITLID\USRDIR\FEATURES\Personal_Area.xml" goto :edit_personal_area
goto :end
...
:add_to_source
MOVE /Y "%pkgbasesources%\APPTITLID\USRDIR\FEATURES\Personal_Area.offline"  "%pkgbasesources%\APPTITLID\USRDIR\FEATURES\Personal_Area.xml"
cls
echo.
%external%\cecho {04}        лллллллллллллллллллллллллллллллллллллллллллллллллллллл{\n}
%external%\cecho {04}        л                                                    л{\n}
...
:remove_from_source
del /Q /S "%pkgbasesources%\APPTITLID\USRDIR\FEATURES\Personal_Area.xml" >NUL
copy "%pkgbaseoriginalsources%\APPTITLID\USRDIR\FEATURES\Personal_Area.offline" "%pkgbasesources%\APPTITLID\USRDIR\FEATURES\Personal_Area.offline"
cls
echo.
%external%\cecho {04}        лллллллллллллллллллллллллллллллллллллллллллллллллллллл{\n}
%external%\cecho {04}        л                                                    л{\n}
...
%bindir%\ssr --nobackup --recurse --encoding utf8 --dir "%pkgbasesources%\APPTITLID\USRDIR\FEATURES" --include "Personal_Area.xml" --alter --search "<!-- Packages items -->" --replace "<!-- Packages items -->/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/<Query class=''type:x-xmb/xmlpackagefolder'' key=''p%ID%'' attr=''p%ID%'' src=''#seg_personalarea_packages_p%ID%''/>"
...
%bindir%\ssr --nobackup --recurse --encoding utf8 --dir "%pkgbasesources%\APPTITLID\USRDIR\FEATURES" --include "Personal_Area.xml" --alter --search "<!-- Folders items -->" --replace "<!-- Folders items -->/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/<Query class=''type:x-xmb/folder-pixmap'' key=''f%ID%'' attr=''f%ID%'' src=''#seg_personalarea_folders_f%ID%''/>"
