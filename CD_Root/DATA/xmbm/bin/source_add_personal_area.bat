...
IF EXIST "%pkgbasexmbmp%\XMBMANPLS\USRDIR\FEATURES\Personal_Area.offline" goto :create_personal_area
IF EXIST "%pkgbasexmbmp%\XMBMANPLS\USRDIR\FEATURES\Personal_Area.xml" goto :edit_personal_area
goto :end
...
:add_to_source
MOVE /Y "%pkgbasexmbmp%\XMBMANPLS\USRDIR\FEATURES\Personal_Area.offline"  "%pkgbasexmbmp%\XMBMANPLS\USRDIR\FEATURES\Personal_Area.xml"
cls
echo.
%external%\cecho {04}        лллллллллллллллллллллллллллллллллллллллллллллллллллллл{\n}
%external%\cecho {04}        л                                                    л{\n}
...
:remove_from_source
del /Q /S "%pkgbasexmbmp%\XMBMANPLS\USRDIR\FEATURES\Personal_Area.xml" >NUL
copy "%pkgbaseoriginalsources%\xmbmp\XMBMANPLS\USRDIR\FEATURES\Personal_Area.offline" "%pkgbasexmbmp%\XMBMANPLS\USRDIR\FEATURES\Personal_Area.offline"
cls
echo.
%external%\cecho {04}        лллллллллллллллллллллллллллллллллллллллллллллллллллллл{\n}
%external%\cecho {04}        л                                                    л{\n}
...
%bindir%\ssr --nobackup --recurse --encoding utf8 --dir "%pkgbasexmbmp%\XMBMANPLS\USRDIR\FEATURES" --include "Personal_Area.xml" --alter --search "<!-- Folders items -->" --replace "<!-- Folders items -->/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/<Query class=''type:x-xmb/folder-pixmap'' key=''f%ID%'' attr=''f%ID%'' src=''#seg_personalarea_folders_f%ID%''/>"
...
%bindir%\ssr --nobackup --recurse --encoding utf8 --dir "%pkgbasexmbmp%\XMBMANPLS\USRDIR\FEATURES" --include "Personal_Area.xml" --alter --search "<!-- Links items -->" --replace "<!-- Links items -->/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/<Item class=''type:x-xmb/module-action'' key=''l%ID%'' attr=''l%ID%''/>"
