...
IF EXIST "%pkgbasesources%\APPTITLID\USRDIR\xmbmp\FEATURES\Personal_Area.offline" goto :create_personal_area
IF EXIST "%pkgbasesources%\APPTITLID\USRDIR\xmbmp\FEATURES\Personal_Area.xml" goto :edit_personal_area
goto :end
...
:add_to_source
MOVE /Y "%pkgbasesources%\APPTITLID\USRDIR\xmbmp\FEATURES\Personal_Area.offline"  "%pkgbasesources%\APPTITLID\USRDIR\xmbmp\FEATURES\Personal_Area.xml"
cls
echo.
%external%\cecho {04}        лллллллллллллллллллллллллллллллллллллллллллллллллллллл{\n}
%external%\cecho {04}        л                                                    л{\n}
...
:remove_from_source
del /Q /S "%pkgbasesources%\APPTITLID\USRDIR\xmbmp\FEATURES\Personal_Area.xml" >NUL
copy "%pkgbaseoriginalsources%\APPTITLID\USRDIR\xmbmp\FEATURES\Personal_Area.offline" "%pkgbasesources%\APPTITLID\USRDIR\xmbmp\FEATURES\Personal_Area.offline"
cls
echo.
%external%\cecho {04}        лллллллллллллллллллллллллллллллллллллллллллллллллллллл{\n}
%external%\cecho {04}        л                                                    л{\n}
...
:: Make changes
%bindir%\ssr --nobackup --recurse --encoding utf8 --dir "%pkgbasesources%\APPTITLID\USRDIR\xmbmp\FEATURES" --include "Personal_Area.xml" --alter --search "<!-- Packages attributes -->" --replace "<!-- Packages attributes -->/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/<Table key=''p%ID%''><Pair key=''icon''><String>/dev_hdd0/game/APPTITLID/USRDIR/xmbmp/IMAGES/pkgmanager.png</String></Pair><Pair key=''title''><String>%packagetitle%</String></Pair><Pair key=''info''><String>%packageinfo%</String></Pair><Pair key=''str_noitem''><String>msg_tool_no_package</String></Pair><Pair key=''child''><String>segment</String></Pair></Table>"
%bindir%\ssr --nobackup --recurse --encoding utf8 --dir "%pkgbasesources%\APPTITLID\USRDIR\xmbmp\FEATURES" --include "Personal_Area.xml" --alter --search "<!-- Packages items -->" --replace "<!-- Packages items -->/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/<Query class=''type:x-xmb/xmlpackagefolder'' key=''p%ID%'' attr=''p%ID%'' src=''#seg_personalarea_packages_p%ID%''/>"
...
set /a ID=%random%*10000/32767+1
:: Make changes
%bindir%\ssr --nobackup --recurse --encoding utf8 --dir "%pkgbasesources%\APPTITLID\USRDIR\xmbmp\FEATURES" --include "Personal_Area.xml" --alter --search "<!-- Folders attributes -->" --replace "<!-- Folders attributes -->/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/<Table key=''f%ID%''><Pair key=''icon''><String>/dev_hdd0/game/APPTITLID/USRDIR/xmbmp/IMAGES/filemanager.png</String></Pair><Pair key=''title''><String>%filemanagertitle%</String></Pair><Pair key=''info''><String>%filemanagerinfo%</String></Pair><Pair key=''str_noitem''><String>msg_no_data</String></Pair><Pair key=''child''><String>segment</String></Pair></Table>"
%bindir%\ssr --nobackup --recurse --encoding utf8 --dir "%pkgbasesources%\APPTITLID\USRDIR\xmbmp\FEATURES" --include "Personal_Area.xml" --alter --search "<!-- Folders items -->" --replace "<!-- Folders items -->/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/<Query class=''type:x-xmb/folder-pixmap'' key=''f%ID%'' attr=''f%ID%'' src=''#seg_personalarea_folders_f%ID%''/>"
...
set /a ID=%random%*10000/32767+1
:: Make changes
%bindir%\ssr --nobackup --recurse --encoding utf8 --dir "%pkgbasesources%\APPTITLID\USRDIR\xmbmp\FEATURES" --include "Personal_Area.xml" --alter --search "<!-- Links attributes -->" --replace "<!-- Links attributes -->/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/<Table key=''l%ID%''><Pair key=''icon''><String>/dev_hdd0/game/APPTITLID/USRDIR/xmbmp/IMAGES/www.png</String></Pair><Pair key=''title''><String>%linktitle%</String></Pair><Pair key=''info''><String>%linkinfo%</String></Pair><Pair key=''module_name''><String>webbrowser_plugin</String></Pair><Pair key=''module_action''><String>%linkurl%</String></Pair></Table>"
%bindir%\ssr --nobackup --recurse --encoding utf8 --dir "%pkgbasesources%\APPTITLID\USRDIR\xmbmp\FEATURES" --include "Personal_Area.xml" --alter --search "<!-- Links items -->" --replace "<!-- Links items -->/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/<Item class=''type:x-xmb/module-action'' key=''l%ID%'' attr=''l%ID%''/>"
