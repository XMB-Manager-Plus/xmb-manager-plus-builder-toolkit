...
%external%\ssr\ssr --nobackup --recurse --encoding utf8 --dir "%pkgbasesources%\APPTITLID\USRDIR" --include "game_settings.xml" --alter --search "<Table key=''original''>" --replace "<Table key=''%themeid%''>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB//SSR_TAB/<Pair key=''icon''><String>/dev_hdd0/game/APPTITLID/USRDIR/IMAGES/theme.png</String></Pair><Pair key=''title''><String>LANG_TITL_SETTINGS-THEMES-PACKS-%themeid%</String></Pair>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB//SSR_TAB/<Pair key=''info''><String>LANG_INFO_SETTINGS-THEMES-PACKS-%themeid%</String></Pair>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB//SSR_TAB/<Pair key=''module_name''><String>webbrowser_plugin</String></Pair>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB//SSR_TAB/<Pair key=''module_action''><String>FILEPROVIDER_BASE_URL/APPTITLID/THEMEPACKS/XMBM%2BvXMBMP-VERSION-THEMEPACK-%themeid%.pkg</String></Pair>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/</Table>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/<Table key=''original''>"
