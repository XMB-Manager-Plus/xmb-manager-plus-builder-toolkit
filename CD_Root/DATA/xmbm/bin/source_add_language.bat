...
%external%\ssr\ssr --nobackup --recurse --encoding utf8 --dir "%pkgbasexmbmp%\XMBMANPLS\USRDIR" --include "game_settings.xml" --alter --search "<Table key=''english''>" --replace "<Table key=''%langcode%''>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB//SSR_TAB/<Pair key=''icon''><String>/dev_hdd0/game/XMBMANPLS/USRDIR/IMAGES/languages/%langcode%.png</String></Pair>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB//SSR_TAB/<Pair key=''title''><String>LANG_TITL_SETTINGS-LANGUAGES-PACKS-%langcode%</String></Pair>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB//SSR_TAB/<Pair key=''info''><String>LANG_INFO_SETTINGS-LANGUAGES-PACKS-%langcode%</String></Pair>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB//SSR_TAB/<Pair key=''module_name''><String>webbrowser_plugin</String></Pair>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB//SSR_TAB/<Pair key=''module_action''><String>http://dl.dropbox.com/u/60710927/XMBMPLUS/RELEASES/LANGUAGEPACKS/XMBM%2BvURL-XMBMP-VERSION-LANGUAGEPACK-%langcode%.pkg</String></Pair>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/</Table>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/<Table key=''english''>"
%external%\ssr\ssr --nobackup --recurse --encoding utf8 --dir "%pkgbasexmbmp%\XMBMANPLS\USRDIR" --include "game_settings.xml" --alter --search "attr=''polish''/>" --replace "attr=''polish''/>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/<Item class=''type:x-xmb/module-action'' key=''%langcode%'' attr=''%langcode%''/>"
:: Create language image for all themes
for /f "tokens=1,2 delims=." %%Y IN ('dir /b %pkgbasexmbmp%\XMBMANPLS\USRDIR\IMAGES\*.') DO (
copy "%pkgbasexmbmp%\XMBMANPLS\USRDIR\IMAGES\ORIGINAL\languages\other.png" "%pkgbasexmbmp%\XMBMANPLS\USRDIR\IMAGES\%%Y\languages\%langcode%.png" > NUL
%external%\ssr\ssr --nobackup --recurse --encoding utf8 --dir "%pkgbasexmbmp%\XMBMANPLS\USRDIR\IMAGES\%%Y" --include "themeinfo.xml" --alter --search "</XMBML>" --replace "<View id=''seg_current_theme_%langcode%''>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB/<Attributes>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/<Table key=''current_theme''>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB//SSR_TAB/<Pair key=''icon''><String>/dev_hdd0/game/XMBMANPLS/USRDIR/IMAGES/settings.png</String></Pair>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB//SSR_TAB/<Pair key=''title''><String>[%langcode%]_TITL_SETTINGS-THEMES-PACKS</String></Pair>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB//SSR_TAB/<Pair key=''info''><String>[%langcode%]_INFO_SETTINGS-THEMES-PACKS</String></Pair>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/</Table>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB/</Attributes>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB/<Items>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/<Query class=''type:x-xmb/module-action'' key=''current_theme'' attr=''current_theme''/>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB/</Items>/SSR_CR//SSR_LF//SSR_TAB/</View>/SSR_CR//SSR_LF//SSR_CR//SSR_LF/</XMBML>"
)
