...
rem :: Add language to game_settings.xml
rem %external%\ssr\ssr --nobackup --recurse --encoding utf8 --dir "%pkgbasesources%\APPTITLID\USRDIR" --include "game_settings.xml" --alter --search "<Table key=''%default_lang%''>" --replace "<Table key=''%langcode%''>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB//SSR_TAB/<Pair key=''icon''><String>/dev_hdd0/game/APPTITLID/USRDIR/IMAGES/languages/%langcode%.png</String></Pair>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB//SSR_TAB/<Pair key=''title''><String>LANG_TITL_SETTINGS-LANGUAGES-PACKS-%langcode%</String></Pair>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB//SSR_TAB/<Pair key=''info''><String>LANG_INFO_SETTINGS-LANGUAGES-PACKS-%langcode%</String></Pair>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB//SSR_TAB/<Pair key=''module_name''><String>webbrowser_plugin</String></Pair>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB//SSR_TAB/<Pair key=''module_action''><String>FILEPROVIDER_BASE_URL/APPTITLID/LANGUAGEPACKS/XMBM%2BvXMBMP-VERSION-LANGUAGEPACK-%langcode%.pkg</String></Pair>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/</Table>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/<Table key=''%default_lang%''>"
rem %external%\ssr\ssr --nobackup --recurse --encoding utf8 --dir "%pkgbasesources%\APPTITLID\USRDIR" --include "game_settings.xml" --alter --search "attr=''pl-PL''/>" --replace "attr=''pl-PL''/>/SSR_CR//SSR_LF//SSR_TAB//SSR_TAB//SSR_TAB/<Item class=''type:x-xmb/module-action'' key=''%langcode%'' attr=''%langcode%''/>"
rem :: Create language image for all themes
rem for /f "tokens=1,2 delims=." %%Y IN ('dir /b %pkgbasesources%\APPTITLID\USRDIR\IMAGES\*.') DO (
rem copy "%pkgbasesources%\APPTITLID\USRDIR\IMAGES\%default_theme%\languages\other.png" "%pkgbasesources%\APPTITLID\USRDIR\IMAGES\%%Y\languages\%langcode%.png" > NUL
