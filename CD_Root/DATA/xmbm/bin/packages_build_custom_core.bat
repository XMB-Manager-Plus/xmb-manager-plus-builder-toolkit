...
FOR /f "tokens=1,2 delims=*" %%C IN ('dir /b "%pkgsource%\custom\%id_xmbmp%\USRDIR\apps\XMB Manager Plus\%%X\%%O\PS3~dev_flash~vsh~resource\*."') DO (
cd "%pkgsource%\custom\%id_xmbmp%\USRDIR\apps\XMB Manager Plus\%%X\%%O\PS3~dev_flash~vsh~resource\%%C"
"%~dp0\%external%\rcomage\rcomage\rcomage.exe" compile --zlib-level 1 "%~dp0\%pkgsource%\custom\%id_xmbmp%\USRDIR\apps\XMB Manager Plus\%%X\%%O\PS3~dev_flash~vsh~resource\%%C\%%C.xml" "%~dp0\%pkgsource%\custom\%id_xmbmp%\USRDIR\apps\XMB Manager Plus\%%X\%%O\PS3~dev_flash~vsh~resource\%%C.rco"
cd "%~dp0"
if not exist "%pkgsource%\custom\apps-temp\XMB Manager Plus\%%X\%%O\PS3~dev_flash~vsh~resource" mkdir "%pkgsource%\custom\apps-temp\XMB Manager Plus\%%X\%%O\PS3~dev_flash~vsh~resource"
move "%pkgsource%\custom\%id_xmbmp%\USRDIR\apps\XMB Manager Plus\%%X\%%O\PS3~dev_flash~vsh~resource\%%C" "%pkgsource%\custom\apps-temp\XMB Manager Plus\%%X\%%O\PS3~dev_flash~vsh~resource\" >NUL
)
)
)
...
FOR /f "tokens=1,2 delims=*" %%C IN ('dir /b "%pkgsource%\custom\apps-temp\XMB Manager Plus\%%X\%%O\PS3~dev_flash~vsh~resource\*."') DO (
del /Q "%pkgsource%\custom\%id_xmbmp%\USRDIR\apps\XMB Manager Plus\%%X\%%O\PS3~dev_flash~vsh~resource\*.rco" >NUL
move "%pkgsource%\custom\apps-temp\XMB Manager Plus\%%X\%%O\PS3~dev_flash~vsh~resource\%%C" "%pkgsource%\custom\%id_xmbmp%\USRDIR\apps\XMB Manager Plus\%%X\%%O\PS3~dev_flash~vsh~resource\" >NUL
)
)
)
