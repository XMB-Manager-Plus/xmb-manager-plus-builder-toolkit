...
cd "%~dp0"
if not exist "%pkgsource%\custom\apps-temp\XMB Manager Plus\%%X\PS3~dev_flash~vsh~resource" mkdir "%pkgsource%\custom\apps-temp\XMB Manager Plus\%%X\PS3~dev_flash~vsh~resource"
move "%pkgsource%\custom\%id_xmbmp%\USRDIR\apps\XMB Manager Plus\%%X\PS3~dev_flash~vsh~resource\%%C" "%pkgsource%\custom\apps-temp\XMB Manager Plus\%%X\PS3~dev_flash~vsh~resource\" >NUL
)
)
