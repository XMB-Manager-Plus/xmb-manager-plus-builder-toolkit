...
cd "%~dp0"
if not exist "%pkgsource%\%%A\apps-temp\XMB Manager Plus\XMB Manager Plus\%%X\PS3~dev_flash~vsh~resource" mkdir "%pkgsource%\%%A\apps-temp\XMB Manager Plus\XMB Manager Plus\%%X\PS3~dev_flash~vsh~resource"
move "%pkgsource%\%%A\%id_xmbmp%\USRDIR\apps\XMB Manager Plus\%%X\PS3~dev_flash~vsh~resource\%%C" "%pkgsource%\%%A\apps-temp\XMB Manager Plus\XMB Manager Plus\%%X\PS3~dev_flash~vsh~resource\" >NUL
)
)
echo - Compiling elf ...
